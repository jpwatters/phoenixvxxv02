 ...
 *
 * Modified by Russ Bruhnke NQ0U for the K9HZ Test Program 
 *
 *
 */
...
//      EncoderFineTune();
    ...
    case 1:
      ...
      {
        G0ORXButtonPressed = -1;//buttonReleased(pin2+16);
      }
    break;
    ...
    case 5:
      ...
      if (state == PRESSED) 
      {
        G0ORXSwitchPressed = (pin-2);   // make zero-based
      } else 
      {
        G0ORXSwitchPressed = -1;//buttonReleased(pin2+16);
      }
      break;
    default:
...
int FrontPanelCheck(uint8_t* encoder_num) 
{
  ...
  {
    *encoder_num = 1;
    Serial.println("Encoder1 = "+String(val));
    return val;
  }
  ...
  {
    *encoder_num = 2;
    Serial.println("Encoder2 = "+String(val));
    return val;
  }
  ...
  {
    *encoder_num = 3;
    Serial.println("Encoder3 = "+String(val));
    return val;
  }
  ...
  {
    *encoder_num = 4;
    Serial.println("Encoder4 = "+String(val));
    return val;
  }
